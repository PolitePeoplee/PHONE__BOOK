...
PHONE_BOOK::void write_to_file() //метод для записи в файл
	{
...
PHONE_BOOK::void enter_fio() //метод для ввода фио
	{
...
PHONE_BOOK::void enter_number() //метод для ввода номера
	{
		do
		{
	...
	PHONE_BOOK::void enter_find_word()
	{
